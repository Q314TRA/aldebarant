...
exports.onCreateNode = ({ node, actions, getNode }) => {
    ...
    if (node.internal.type === 'CompanyServicesJson') {
        createNodeField({
            node,
            name: "slug",
            value: slugify(node.title)
...
exports.createPages = async ({ graphql, actions }) => {
    ...
    const servicePageCompany = path.resolve("./src/templates/service-template/company-template.js")
    ...
    const companyservices = result.data.allCompanyServicesJson.edges;
    companyservices.forEach(({ node }) => {
        createPage({
            path: `company-service/${node.fields.slug}`,
            component: servicePageCompany,
            context: {
